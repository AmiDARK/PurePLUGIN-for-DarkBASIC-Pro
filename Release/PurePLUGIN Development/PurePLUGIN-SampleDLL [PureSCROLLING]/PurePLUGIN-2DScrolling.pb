...
ProcedureCDLL.s AGetDependencyID00YAPBDH0Z( NumID.l )
  Select NumID
    Case 0 : NewPTR.s = PeekS( ?DEP_PurePLUGIN )      ; Include #1 : PurePLUGIN system for SETUP the Plugin.
    Case 1 : NewPTR.s = PeekS( ?DEP_DBPImage )        ; Include #2 : DBproImageDebug.DLL
    Default : NewPTR = ""
   EndSelect
...
ProcedureCDLL.l PScrollingInit()
  If *GlobPtr = 0 : InitialiseCorePtr() : EndIf
  If PPInitialized = 0
    PPInitialized = InitDLLBase()
   EndIf
...
; Now you can include the PureBASIC source code file that will contain all your TPC Procedures
  IncludeFile "PurePLUGIN-2DScrollInclude.pb"
;
; **************************************************************
...
;
DONNEES:
Data.s "DarkBasic Professional PurePLUGIN-2DScrolling / "
Data.s "PurePLUGIN-2DScrolling.dll Ver 1.0 [ 080308 ]  / "
...
; FirstLine = 65
; Folding = --
; Executable = PureSCROLLING.dll
; AddResource = PureSCROLLING.rc